print("Manual Intellegence V1.31")
...
while True:
    ...
    if matches_any(bye_patterns, ask):
    ...
    elif "is it raining" in ask or "whats the weather" in ask or "what's the weather" in ask or "is it cloudy" in ask or "is it rainy" in ask or "does it rain" in ask or "will it rain" in ask:
        ...
        print(f"Current available commands:\n  current time = Tells the current time \n  current date = Tells today's date\n  tell me a joke = Tells a random joke\n  terminal = Opens the oNx terminal\n  exit = Exit Manual Intellegence\n  math expressions (e.g '5+5' or '10/2')\n  wopen = Opens a website in your default browser")
        ...
        run_terminal() # where the rabbit hole starts
